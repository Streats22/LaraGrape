...
<footer class="site-footer bg-gradient-to-tr from-primary-900 via-secondary to-accent text-primary-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <p class="text-primary-300 mb-6 max-w-md">
                ...
                <div class="space-y-2 text-sm text-primary-300">
                    @if($generalSettings['contact_email'])
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="mailto:{{ $generalSettings['contact_email'] }}" class="hover:text-primary-50 transition-colors">
                    ...
                    @if($generalSettings['contact_phone'])
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="tel:{{ $generalSettings['contact_phone'] }}" class="hover:text-primary-50 transition-colors">
                    ...
                    @foreach(\App\Models\Page::inMenu()->take(5)->get() as $menuPage)
                        <li>
                            <a href="{{ route('page.show', $menuPage->slug) }}" 
                               class="text-primary-300 hover:text-primary-50 transition-colors">
                                {{ $menuPage->title }}
                            </a>
                        </li>
                    @endforeach
                ...
                <div class="max-w-md">
                    ...
                    <form class="flex space-x-2">
                        <input type="email" 
                               ...
                               class="flex-1 px-4 py-2 bg-primary-800 border border-primary-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent text-primary-50 placeholder-primary-400">
                        <button type="submit" 
                                class="px-6 py-2 bg-primary-600 hover:bg-primary-700 text-primary-50 rounded-lg transition-colors">
                            Subscribe
                        </button>
                    </form>
                </div>
        ...
        @endif
        <div class="mt-12 pt-8 border-t-2 border-primary-700 text-center text-primary-200">
            <div class="text-sm">
