...
<div class="video-block py-8">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            <h3 class="text-2xl font-bold mb-6 text-center text-primary-900" data-gjs-type="text" data-gjs-name="video-title">Video Title</h3>
            ...
            <p class="text-primary-600 mt-4 text-center" data-gjs-type="text" data-gjs-name="video-description">
