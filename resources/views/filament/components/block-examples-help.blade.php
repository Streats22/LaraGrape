<div class="prose max-w-none">
    ...
    <h3>HTML Example</h3>
    <pre class="bg-primary-100 text-primary-800 p-4 rounded overflow-x-auto"><code>&lt;div class="custom-block bg-gradient"&gt;
...
&lt;/div&gt;
    ...
    <h3>CSS Example</h3>
    <pre class="bg-primary-100 text-primary-800 p-4 rounded overflow-x-auto"><code>.custom-block {
    padding: 2rem;
    border-radius: 1rem;
...
.block-btn {
    ...
    <pre class="bg-primary-100 text-primary-800 p-4 rounded overflow-x-auto"><code>@php
    $greeting = 'Hello, ' . ($name ?? 'World') . '!';
@endphp
&lt;div&gt;@{{ $greeting }}&lt;/div&gt;
</code></pre>
    <h3>Conventions</h3>
    <ul class="text-primary-800 space-y-2">
        <li>
