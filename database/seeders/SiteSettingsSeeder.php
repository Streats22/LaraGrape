...
class SiteSettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            // General Settings
            ['key' => 'site_name', 'value' => 'My Website', 'type' => 'text', 'group' => 'general', 'label' => 'Site Name', 'description' => 'The name of your website', 'sort_order' => 1],
            ...
            // Header Settings
            ['key' => 'header_logo_text', 'value' => 'My Website', 'type' => 'text', 'group' => 'header', 'label' => 'Logo Text', 'description' => 'Text to display as logo', 'sort_order' => 1],
            ...
            // Footer Settings
            ['key' => 'footer_logo_text', 'value' => 'My Website', 'type' => 'text', 'group' => 'footer', 'label' => 'Footer Logo Text', 'description' => 'Text to display in footer', 'sort_order' => 1],
            ...
            ['key' => 'footer_content', 'value' => '© 2024 My Website. All rights reserved.', 'type' => 'textarea', 'group' => 'footer', 'label' => 'Footer Content', 'description' => 'Main footer content (supports HTML)', 'sort_order' => 4],
            ...
            // SEO Settings
            ['key' => 'seo_title', 'value' => 'My Website - Web Development', 'type' => 'text', 'group' => 'seo', 'label' => 'Default Page Title', 'description' => 'Default title for pages without custom title', 'sort_order' => 1],
